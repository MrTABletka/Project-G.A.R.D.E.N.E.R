...
def menu():
    ...
    button_raid_image = pygame.transform.scale(button_raid_image,
                                               (
                                               button_raid_image.get_width() / 7,
                                               button_raid_image.get_height() / 7))
    button_newgame_image = pygame.transform.scale(button_newgame_image, (
        button_newgame_image.get_width() / 7,
        button_newgame_image.get_height() / 7))
    button_uprav_image = pygame.transform.scale(button_uprav_image,
                                                (
                                                button_uprav_image.get_width() / 7,
                                                button_uprav_image.get_height() / 7))
    button_shop_image = pygame.transform.scale(button_shop_image,
                                               (
                                               button_shop_image.get_width() / 7,
                                               button_shop_image.get_height() / 7))
    button_zapis_image = pygame.transform.scale(button_zapis_image,
                                                (
                                                button_zapis_image.get_width() / 7,
                                                button_zapis_image.get_height() / 7))
    button_stats_image = pygame.transform.scale(button_stats_image,
                                                (
                                                button_stats_image.get_width() / 7,
                                                button_stats_image.get_height() / 7))
    button_exit_image = pygame.transform.scale(button_exit_image,
                                               (
                                               button_exit_image.get_width() / 7,
                                               button_exit_image.get_height() / 7))

    button_raid_pos = (
    screen_width // 2 - button_raid_image.get_width() // 2, 10)
    button_newgame_pos = (
    screen_width // 3 - button_newgame_image.get_width() // 2, 150)
    button_uprav_pos = (
    screen_width // 1.5 - button_uprav_image.get_width() // 2, 150)
    button_shop_pos = (
    screen_width // 3 - button_shop_image.get_width() // 2, 275)
    button_zapis_pos = (
    screen_width // 1.5 - button_zapis_image.get_width() // 2, 275)
    button_stats_pos = (
    screen_width // 3 - button_stats_image.get_width() // 2, 400)
    button_exit_pos = (
    screen_width // 1.5 - button_exit_image.get_width() // 2, 400)
